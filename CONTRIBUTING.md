...
- Before submitting a bug report test using the [latest version of the project](https://github.com/per1234/InoPinTester/archive/master.zip) to be sure it hasn't already been fixed. **Don't report issues that only occur with old versions of the project.**
- Search [existing pull requests and issues](https://github.com/per1234/InoPinTester/issues?q=) to be sure it hasn't already been reported. **Do not submit duplicate issue reports.** If you have additional information to provide about the issue then please comment on that issue.
- Open an issue at https://github.com/per1234/InoPinTester/issues/new.
...
## Pull Requests
- Search [existing pull requests and issues](https://github.com/per1234/InoPinTester/pulls?q=) to make sure the change hasn't already been proposed.
...
- If appropriate, add or update tests in the [.travis.yml file](https://github.com/per1234/WatchdogLog/blob/master/.travis.yml).
- Update the [documentation](https://github.com/per1234/InoPinTester/README.md) if your changes require it. This should be done in the same commit as the change.
...
- Open a pull request at https://github.com/per1234/InoPinTester/compare.
